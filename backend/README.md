...
## Project Structure
    ...
    ├── beta_safetbox_test_37284  # Django project configurations
...
1. Clone this repo and `cd beta_safetbox_test_37284`
...
2. Clone this repo and `cd beta_safetbox_test_37284`
